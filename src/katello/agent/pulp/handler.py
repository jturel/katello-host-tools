...
class ContentHandler(object):
    ...
    def install(self, units, options):
        ...
        Args:
            units (list): Content to be installed.
    ...
    def update(self, units, options):
        ...
        Args:
            units (list): Content to be updated.
            options (dict): Handler specific options.
    ...
    def uninstall(self, units, options):
        ...
        Args:
            units (list): Content to be uninstalled.
            options (dict): Handler specific options.
...
class PackageHandler(ContentHandler):
    ...
    def install(self, units, options):
        ...
        Args:
            units (list): Packages to be installed.
            options (dict): Handler specific options.
        ...
        patterns = [Pattern(p) for p in units]
    ...
    def update(self, units, options):
        ...
        Args:
            units (list): Packages to be updated.
            options (dict): Handler specific options.
    ...
    def uninstall(self, units, options):
        ...
        Args:
            units (list): Packages to be uninstalled.
            options (dict): Handler specific options.
...
class GroupHandler(ContentHandler):
    ...
    def install(self, units, options):
        ...
        Args:
            units (list): Groups to be installed.
            options (dict): Handler specific options.
    ...
    def uninstall(self, units, options):
        ...
        Args:
            units (list): Groups to be uninstalled.
            options (dict): Handler specific options.
...
class ErratumHandler(ContentHandler):
    ...
    def install(self, units, options):
        ...
        Args:
            units (list): Errata to be installed.
            options (dict): Handler specific options.
